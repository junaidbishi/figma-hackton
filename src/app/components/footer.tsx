    ...
    return (
        ...
        <div  className="flex h-full md:h-[400px] flex-col md:flex-row justify-between items-start p-5 pt-[160px] sm:pt-32 border-b ">
         ...
         <div className="flex flex-col sm:flex-row justify-between items-center mt-3">
                <p className="text-sm">Shop.co © 2024-2025, All Rights Reserved</p>
                <div className="flex items-center ">
                    <Image src={"/foot-1.png"} className="w-[50px]" width={100} height={100} alt="pic"/>
                    <Image src={"/foot-2.png"} className="w-[50px]" width={100} height={100} alt="pic"/>
                    <Image src={"/foot-3.png"} className="w-[50px]" width={100} height={100} alt="pic"/>
                    <Image src={"/foot-4.png"} className="w-[50px]" width={100} height={100} alt="pic"/>
                    <Image src={"/foot-5.png"} className="w-[50px]" width={100} height={100} alt="pic"/>
                </div>
            </div>
        </main>
    )
